...
L'objectif est d'incruster toute ou partie de l'image S dans l'image T. En terme de manipulations, cela consiste à faire un mélange ou mixage des deux images, ou encore à effectuer un clonage lisse de la seconde image dans la première.
...
\end{figure}
\end{center}
Cette image a été obtenue à l'aide d'un de nos algorithme, nous joindrons un fichier annexe, avec différents collages, dont celui-ci avec le rapport.\newline
\paragraph{Remarques}
...
\begin{itemize}
    ...
    \item I, l'inconnue, la partie de l'image que nous ne connaissons pas et que nous voulons trouver, elle se situe dans $\Omega$
\end{itemize}
